...
const char *data_file = "F:/Documents/TEMP/HK Mam/kro124p.txt";
const char *sol_file = "F:/Temp_Linux_WorkDir/TSP-BAT/sol_kro124p.txt";

const int opt_fit = 36230;
int **matrix;
int ROW;
...
DWORD WINAPI processPairs(LPVOID data);
