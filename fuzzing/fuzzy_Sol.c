...
#define DIM 17             // number of dimensions
...
const char *fName = "/home/xron/Drives/Docs_And_Media/Temp_Linux_WorkDir/TSP-BAT/matrix.txt";
const char *redefined_matrix = "/home/xron/Drives/Docs_And_Media/Documents/Everything/Code-More/Application Development/Programming Languages/C/Others/HK mam TSP Prob 2/fuzzing/re_br17.txt";
const char *output = "/home/xron/Drives/Docs_And_Media/Documents/Everything/Code-More/Application Development/Programming Languages/C/Others/HK mam TSP Prob 2/fuzzing/re_br17_sol.txt";
const int opt_fit = 39;
int **matrix;
float ***new_matrix;
int ROW;
...
int main(int argc, char const *argv[])
{
    ...
    //     for (int j = 0; j < ROW; j++)
    //     {
    //         printf("( %.2f,  ", new_matrix[i][j][0]);
    //         printf("%.2f,  ", new_matrix[i][j][1]);
    //         printf("%.2f ), ", new_matrix[i][j][2]);
    //     }
    //     printf("\n\n");
    // }
...
int **read_matrix(const char *fName, int *rows)
{
    ...
    new_matrix = (float ***)malloc(row_count * sizeof(float **));
    for (int i = 0; i < row_count; i++)
    {
        new_matrix[i] = (float **)malloc(row_count * sizeof(float *));
        for (int j = 0; j < row_count; j++)
            new_matrix[i][j] = (float *)malloc(3 * sizeof(float));
    }

    file = fopen(redefined_matrix, "w");
