...
#define DIM 34        // number of dimensions
#define OPTIMUM 1286 // Optimum fitness for this dimension
...
const char *fName = "/home/sreejan_naru_fit_csebct21/TSP_BAT/DATASET/ftv33.txt";
const char *redefined_matrix = "/home/sreejan_naru_fit_csebct21/TSP_BAT/DATASET/re_ftv33.txt";
const char *output = "/home/sreejan_naru_fit_csebct21/TSP_BAT/SOLUTION/ftv33_sol.txt";
const int opt_fit = OPTIMUM;
int **matrix;
float ***new_matrix;
int ROW;
